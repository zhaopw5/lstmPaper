...
def main():
    ...
    # # 保存合并后的数据到指定目录
    # output_file = output_dir / "solar_physics_data_1985_2025_osf.csv"
    ...
    merged_data[numeric_cols] = merged_data[numeric_cols].interpolate(method='linear')
    ...
    # cols_to_smooth = ['HMF', 'wind_speed', 'SSN', 'HCS_tilt', 'daily_OSF']
    ...
    # 保存插值后的连续数据
    output_file_ma = output_dir / "solar_physics_data_1985_2025_osf.csv"
