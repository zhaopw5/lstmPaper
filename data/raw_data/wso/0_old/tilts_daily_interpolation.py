#!/usr/bin/env python3
"""
线性插值处理tilts_update文件
将Carr Rotation分辨率的tilts数据转换为日分辨率
面向过程的处理方式
"""
...
# 文件路径
input_file = '/home/zpw/Files/lstmPaper/data/wso/tilts_update.csv'
output_file = '/home/zpw/Files/lstmPaper/data/wso/tilts_daily.csv'
plot_file = '/home/zpw/Files/lstmPaper/data/wso/tilts_comparison.png'
