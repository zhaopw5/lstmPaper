...
df = pd.read_csv(f'{output_dir}solar_physics_data_1985_2025_cycle_prediction.csv')
...
# 保存
df.to_csv(f'{output_dir}solar_physics_data_1985_2025_cycle_prediction_smoothed.csv', index=False)
