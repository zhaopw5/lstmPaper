...
# 刚度边缘定义
RIGIDITY_BIN_EDGES = [1.71, 1.92, 2.15, 2.4, 2.67, 2.97, 3.29, 3.64, 4.02, 4.43, 4.88, 5.37, 5.9, 6.47, 7.09, 7.76, 8.48, 9.26, 10.1]
# 使用的刚度（去除最后一个边缘）
...
def load_and_check_data():
    ...
    for rigidity in RIGIDITY_VALUES:
        ...
        if len(rigidity_data) > 0:
            ...
            rigidity_data = rigidity_data.rename(columns={HELIUM_FLUX_COL: f'helium_flux_{rigidity}GV'})
